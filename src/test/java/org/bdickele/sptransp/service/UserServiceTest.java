...
public class UserServiceTest {
    ...
    public void creation_of_uid_should_work() {
        ...
        StrictAssertions.assertThat(result).isEqualTo("johndo4");
        ...
        StrictAssertions.assertThat(result).isEqualTo("john5");
    }
    ...
    public void suffix_extracting_should_work() {
        ...
        StrictAssertions.assertThat(result).isEmpty();

        result = UserService.extractSuffixNumberFromUid("john12", prefix);
        StrictAssertions.assertThat(result).contains(12);
    }
    ...
    public void get_max_index_of_suffixes_should_return_a_value(List<String> uids, String prefix,
        ...
        StrictAssertions.assertThat(max).isEqualTo(expectedResult);
    }
}
